...
VALIDATION_DATASET_FILE="examples/distill/Wan2.1-T2V-1.3B-Diffusers/crush_smol/validation.json"
OUTPUT_DIR="checkpoints_non_lora/wan_t2v_finetune"
...
training_args=(
  ...
  --weight_only_checkpointing_steps 1
)
